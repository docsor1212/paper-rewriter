...
version: 1.1.1
description: >
  Academic writing style toolkit, bilingual CN/EN: style-pattern self-check report,
  deterministic text cleanup (model artifacts, punctuation, filler phrases), integrity
...
- Writes **only** to the `-o`/`--output` paths you specify.
